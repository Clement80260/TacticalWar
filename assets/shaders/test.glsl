...
#define ParticleMinSize         0.8
#define ParticleMaxSize         1.
...
void main( void ) {
    ...
    signedUV.y -= 0.20;
    float freqA = mix( 0.4, 1.2, sin(40.*time + 40.0) * 0.5 + 0.5 );
    float freqB = mix( 0.4, 1.2, cos(20.*time + 20.0) * 0.5 + 0.5 );
    float freqC = mix( 0.4, 1.2, tan(20.*time + 10.0) * 0.5 + 0.5 );
    ...
    float multiplier = cos(time * 1.) + 1.2;    
	multiplier *= 0.25;
